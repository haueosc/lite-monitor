...
VALUES (1, 'admin', '1002302241@qq.com', '$2a$10$2WIHD6ZkM5AkV7iNZ0Uh4uiNgNrXMgXXq6zq8aUJRW34e5nWDcDf.', 'admin',
        '2024-04-04 14:45:54', NULL),
       (6, 'liyusen', '123456@qq.com', '$2a$10$Ry0MiC3Kvo5ebXCEi2/jjusX7CuB8shlhNicjY.PdXWNtKC8hz5oa', 'user',
        '2024-04-18 09:16:54', '[
         35388460,
         16090204
       ]');
...
(
    ...
    `report_memory`    double DEFAULT 0.8 NOT NULL,
    `report_cpu_usage` double DEFAULT 0.8 NOT NULL
        PRIMARY KEY (`client_id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `db_client_detail`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `db_client_detail`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `db_client_ssh`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `db_client_ssh`
    ENABLE KEYS */;
UNLOCK TABLES;
